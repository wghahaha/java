...
public class Hello {
 ...
 /* pubic-->访问修饰符 static-->关键字  void-->返回类型   main-->方法名 String[]-->Sring类  args-->字符串数值*/
...
注意：==类名大写是由于命名规范的原因。因为java区分大小写这样可以区分同名的类，变量！！比如：String 是类，你可以声名一个小写的string 作为变量==
...
<img src="https://www.runoob.com/wp-content/uploads/2013/12/20210105-java-object-1.png" alt="img" style="zoom:67%;" />
...
Byte    long     short      int     float     double     boolean       char
...
<img src="https://www.runoob.com/wp-content/uploads/2013/12/java-string-20201208.png" alt="img" style="zoom:67%;" />
...
<img src="https://www.runoob.com/wp-content/uploads/2013/12/2021-03-01-java-stringbuffer.svg" alt="img" style="zoom:67%;" />
...
我们发现如果输入的数据带有空格，那么空格后的内容就不会输出。我们可以 使用 nextLine 方法：
